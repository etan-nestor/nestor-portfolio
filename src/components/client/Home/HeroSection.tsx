      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2">
            ...
            >
              <span className="text-blue-400 font-mono px-4 py-2 bg-blue-900/20 rounded-full flex items-center gap-2 w-max">
            ...
            <motion.p
              ...
              className="text-gray-400 mb-8 max-w-lg text-lg"
            >
            ...
            >
              <Link
                href="#projects"
                className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg font-medium flex items-center gap-2 group hover:shadow-lg hover:shadow-blue-500/20 transition-all"
              >
              ...
              <Link
                href="/client/ask"
                className="px-6 py-3 border border-blue-600/50 rounded-lg font-medium hover:bg-blue-900/20 hover:border-blue-600/80 hover:text-white transition-all"
              >
